...
<body>
  ...
  <main class="about-container flex-group article">
    ...
    <h2 id="présentation-du-site">Présentation du Site</h2>
    <figure>
    ...
    <h3 id="la-fin-du-début-comment-jouer">La fin du début | Comment jouer
      ?</h3>
    ...
    <h2 id="nos-technologies">Nos Technologies</h2>
    <p>Pour la création de ce site, un de nos objectifs a été de baser les
      ...
      avec MySql.</p>
    <h3 id="le-front-end-leaflet-et-mapillary">Le front-end: Leaflet et
      Mapillary</h3>
    ...
    <p>L’outil principal d’exploration quand à lui est Mapillary, avec
      ...
      repérer.</p>
    <h3 id="le-back-end-php-et-sql">Le back-end: PHP et SQL</h3>
    ...
    <h2 id="notre-processus-de-création">Notre processus de création</h2>
    <h3 id="création-dun-cahier-des-charges">Création d’un cahier des
      charges</h3>
    ...
    <h3 id="la-conception-de-la-base-de-données">La conception de la base de
      données</h3>
    ...
    <h3 id="création-de-la-spécification-de-notre-api">Création de la
      spécification de notre API</h3>
    <p>Après avoir effectué la conception de la base de données, nous nous
      ...
      back-end.</p>
    <h3 id="implémentation-en-parallèle-du-front-et-back-end">Implémentation
      en parallèle du front et back end</h3>
    ...
    <h3 id="nos-difficultés-et-ce-que-lon-a-appris">Nos difficultés et ce
      que l’on a appris</h3>
